...
"""
Representación del Grafo: El grafo se representa como un diccionario en el que las claves son los nodos y los valores son diccionarios de vecinos y sus respectivos pesos.

Dijkstra Paso a Paso:

Se utiliza una cola de prioridad (heapq) para explorar los nodos con la distancia más corta acumulada.
Cada nodo se procesa mostrando las actualizaciones de distancias y caminos en la consola.
Graficar el Grafo:

Se utiliza NetworkX para crear y visualizar el grafo.
Se resaltan los caminos más cortos en rojo utilizando la información de los caminos generados por Dijkstra.
Ejecución: El código simula el algoritmo de Dijkstra y muestra en consola cada paso, además de generar una gráfica que visualiza el grafo con los caminos más cortos resaltados.
"""